# Exemplo de Código em Python com scikit-learn - utilizaremos o conjunto de 
#dados Iris para demonstrar a aplicação de uma Árvore de Decisão em um problema de classificação.
